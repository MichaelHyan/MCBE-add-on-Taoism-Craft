...
#### 铜镜【法】
- 核心功能：使用后获得增益——移速提升2 + 跳跃提升2 + 最大血量提升50%
- 副作用：
  1. 一次性物品
  2. 增益持续1分钟「不建议使用」
- 合成方式：8个铜锭 + 1个符箓
...
- 核心功能：
  ...
  2. 或破坏面前3×3×3范围内实体并吸收
- 副作用：吸收后的物品回归自然循环（无法获取）
- 合成方式：5个铜锭 + 2个符箓 + 1个雷击木（木板）
...
#### 金刚琢
- 核心功能：缴械附近生物，使其失去攻击能力
- 副作用：使用后自身陷入虚弱状态（持续10秒）
- 合成方式：4个铁锭 + 4个雷击木 + 1个符箓
